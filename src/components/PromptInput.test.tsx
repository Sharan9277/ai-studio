...
describe('PromptInput', () => {
  ...
  test('renders prompt input with label', () => {
    ...
    expect(screen.getByPlaceholderText('Describe how you want to transform your image...')).toBeInTheDocument();
  });
  ...
  test('shows help text', () => {
    ...
    expect(screen.getByText('Be specific about the style, mood, or transformation you want to apply.')).toBeInTheDocument();
  });
});